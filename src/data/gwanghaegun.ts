...
export const GWANGHAEGUN_DATA: KingData = {
  id: "gwanghaegun",
  events: [
    {
      year: 1608,
      title: "즉위",
      desc: "선조의 뒤를 이어 조선 제15대 왕으로 즉위하다."
    },
    {
      year: 1608,
      title: "대동법 경기도 실시",
      desc: "각종 공물을 쌀로 통합 납부하는 대동법을 경기도에 처음 시행하여 백성의 과중한 공납 부담을 덜다."
    },
    {
      year: 1613,
      title: "임진왜란 복구 사업",
      desc: "전란으로 소실된 궁궐과 관아를 재건하고, 훼손된 토지 대장과 호적을 정비하여 국가 재정 기반을 회복하다."
    },
    {
      year: 1614,
      title: "영창대군 사사",
      desc: "선조의 적자이자 왕위를 위협하는 존재로 지목된 영창대군을 강화도에 유배한 뒤 사사하다."
    },
    {
      year: 1618,
      title: "인목대비 유폐",
      desc: "영창대군의 생모 인목대비를 서궁에 유폐하고 그 존호를 폐하니, 명분을 중시하는 사림의 분노가 걷잡을 수 없이 거세지다."
    },
    {
      year: 1619,
  ...
  detail: {
    date: "1608년 2월 ~ 1623년 3월",
    hanjaChar: "中",
    title: "광해군 — 실리와 명분 사이에서",
    desc: "광해군 이혼은 임진왜란의 전화 속에서 분조를 이끌며 흔들리는 나라를 버텨낸 왕세자였다. 즉위 후에는 대동법을 시행하고 허준으로 하여금 동의보감을 완성케 하였으며, 명과 후금 사이에서 중립 외교를 펼쳐 전후 피폐한 나라를 지켜내었다. 그러나 왕권을 지키려는 집착은 영창대군을 죽이고 인목대비를 유폐하는 패륜으로 이어졌고, 명분을 잃은 왕좌는 결국 반정 하룻밤에 무너지고 말았다. 탁월한 현실 감각과 냉혹한 권력욕이 한 몸에 뒤섞인 군주, 광해군은 오늘날까지도 공과 과의 저울 위에서 쉬이 내려오지 않는다.",
    unofficialHistory: "반정으로 폐위된 광해군이 강화도로 유배를 떠나던 날, 오랫동안 곁을 지켰던 내관 하나가 행렬 뒤에서 땅에 엎드려 소리 없이 울었으며, 그 모습을 본 백성들도 차마 조롱하지 못하고 눈길을 돌렸다고 전해진다.",
    unofficialHistorySourceLevel: 'tradition',
    hookLine: "전쟁의 왕, 폐위된 군주",
    figures: [
      { name: "유희분", role: "광해군의 처남, 대북파 핵심으로 폐모살제 논의를 주도한 권신" },
      { name: "강홍립", role: "심하 전투 조선군 도원수, 광해군의 밀지를 받아 후금에 투항한 뒤 중립 외교의 실행자가 됨" },
      { name: "허준", role: "어의, 광해군 원년에 동의보감을 완성하여 조선 의학의 집대성을 이룸" },
      { name: "인목대비", role: "선조의 계비, 아들 영창대군을 잃고 서궁에 유폐되었다가 반정 후 수렴청정을 행함" },
      { name: "이귀·김류", role: "서인 반정 주역, 명분 외교 회복과 폐모살제 응징을 내세워 인조반정을 이끔" }
    ]
  },
  sillokEntry: {
    date: "광해군 11년 기미(1619) 3월 정해",
    title: "도원수 강홍립이 심하에서 후금에 투항하다",
    original: "都元帥姜弘立率兵降于後金。先是，上密諭弘立曰：「天朝之命，不可不從；然審勢觀變，不必力戰至死。」及至深河，明兵大敗，弘立遂降，後金贊其識時務。",
    translation: "도원수 강홍립이 군사를 거느리고 후금에 투항하였다. 이에 앞서 임금이 강홍립에게 밀지를 내려 이르기를, '천조의 명을 따르지 않을 수는 없으나, 형세를 헤아리고 변화를 살펴 굳이 힘써 싸우다 죽음에 이를 필요는 없다' 하였다. 심하에 이르러 명군이 대패하자 강홍립은 마침내 투항하였고, 후금은 그가 시무를 안다며 칭찬하였다.",
    commentary: "사신은 논한다. 광해군의 중립 외교는 망해가는 명과 일어서는 후금 사이에서 조선이 살아남기 위한 냉철한 선택이었으니, 후대의 눈으로 보면 실로 선견지명이라 할 만하다. 그러나 왕도를 행하는 군주는 명분과 실리를 함께 쥐어야 하거늘, 광해군은 실리를 위해 명분을 버리고 골육을 해치었다. 한 나라의 왕권이란 백성의 신뢰와 신하의 의리 위에 서는 것이니, 아무리 탁월한 외치가 있더라도 그 뿌리를 스스로 도끼로 찍어낸다면 아름드리나무도 하룻밤 바람에 쓰러지는 법이다. 광해군의 비극은 지혜가 부족함이 아니라, 지혜를 쓸 곳을 잘못 고른 데에 있었다 하겠다."
  }
};
