...
export const SEONGJONG_DATA: KingData = {
  ...
  detail: {
    ...
    figures: [
      ...
      { name: "노사신 (盧思愼)", role: "대신. 『동국여지승람』 편찬을 주관하고 성종 대 문물 정비에 힘쓰다." },
      { name: "성현 (成俔)", role: "문신·음악가. 『악학궤범』을 찬진하여 조선 예악 문화의 체계를 세우다." },
      { name: "폐비 윤씨 (廢妃 尹氏)", role: "성종의 계비. 투기의 죄목으로 폐서인된 후 사사되었으며, 그 아들 연산군의 치세에 돌이킬 수 없는 파란을 남기다." },
    ],
  },
  sillokEntry: {
    date: "성종 16년 (1485) 1월 1일",
    title: "경국대전을 반포하다",
    original: "頒經國大典於中外。敎曰：「祖宗朝累葉相承，憲章已具，然散在諸書，難於稽考。今撰集成典，以垂永式，中外一遵，毋或違越。」",
    translation: "경국대전을 중외에 반포하였다. 교서에 이르기를, '조종 대대로 서로 전해 온 헌장이 이미 갖추어져 있으나 여러 책에 흩어져 있어 살펴보기 어려웠다. 이제 모아 대전을 편찬하였으니 영원한 법식으로 삼아, 중외가 한결같이 준수하고 어기는 일이 없도록 하라'고 하였다.",
    commentary: "사신은 논한다. 성종께서 경국대전을 반포하심은 진실로 조선 만세의 공이라 할 만하다. 법이란 본디 사람을 살리는 그릇이니, 대전이 선포된 날 백성은 비로소 의지할 기둥을 얻었다 할 것이다. 그러나 신은 홀로 마음이 편치 않으니, 같은 치세에 폐비 윤씨를 사사한 일이 있었기 때문이다. 법은 만천하에 포고되어 빈틈이 없었으나, 그 법이 후궁의 질투와 대신의 입씨름 사이에서 왕비 한 사람의 목숨을 구하지 못하였다. 법전의 글자는 빛났으되, 궁중 깊은 곳의 원한은 어둠 속에서 자라났다. 훗날 연산군이 칼을 들고 갑자년의 화를 일으켰을 때, 그 칼날은 경국대전 어느 조문으로도 막지 못하였다. 성종의 치세가 빛날수록, 그 이면에 움튼 씨앗의 무게 또한 무거운 것이니, 역사를 기록하는 자는 이 두 가지를 함께 보아야 할 것이다.",
  },
};
